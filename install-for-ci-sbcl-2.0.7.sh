...
# My version of
# https://github.com/roswell/roswell/blob/master/scripts/install-for-ci.sh which
# forces version 2.0.7 of SBCL since there seems to be an error in the SBCL
# install of roswell right now.
